...
public class ShixizhiweiToudiEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShixizhiweiToudiEntity() {

	}

	public ShixizhiweiToudiEntity(T t) {
		try {
     ...
     * 实习
     */
    @ColumnInfo(comment="实习",type="int(11)")
    ...
    public String toString() {
        return "ShixizhiweiToudi{" +
            ", id=" + id +
            ", jianliId=" + jianliId +
            ", shixizhiweiId=" + shixizhiweiId +
            ", insertTime=" + DateUtil.convertString(insertTime,"yyyy-MM-dd") +
            ", shixizhiweiToudiYesnoTypes=" + shixizhiweiToudiYesnoTypes +
            ", shixizhiweiToudiYesnoText=" + shixizhiweiToudiYesnoText +
            ", shixizhiweiToudiShenheTime=" + DateUtil.convertString(shixizhiweiToudiShenheTime,"yyyy-MM-dd") +
