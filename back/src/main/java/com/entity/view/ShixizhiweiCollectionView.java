...
public class ShixizhiweiCollectionView extends ShixizhiweiCollectionEntity implements Serializable {
	...
	*/
	...
	private String shixizhiweiCollectionValue;
	...
	public ShixizhiweiCollectionView() {

	}

	public ShixizhiweiCollectionView(ShixizhiweiCollectionEntity shixizhiweiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, shixizhiweiCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getShixizhiweiCollectionValue() {
		return shixizhiweiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setShixizhiweiCollectionValue(String shixizhiweiCollectionValue) {
		this.shixizhiweiCollectionValue = shixizhiweiCollectionValue;
	}
	...
	public String toString() {
		return "ShixizhiweiCollectionView{" +
			", shixizhiweiCollectionValue=" + shixizhiweiCollectionValue +
