...
*/
@TableName("shixijilu")
public class ShixijiluView extends ShixijiluEntity implements Serializable {
	...
	*/
	...
	public ShixijiluView() {

	}

	public ShixijiluView(ShixijiluEntity shixijiluEntity) {
		try {
			BeanUtils.copyProperties(this, shixijiluEntity);
