...
var centerMenu = [
    ...
    ,{
        name: '职位收藏',
        url: '../shixizhiweiCollection/list.html'
    }
    ,{
        name: '实习申请',
        url: '../shixizhiweiToudi/list.html'
    }
    ,{
        name: '实习记录',
        url: '../shixijilu/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '职位实习',
        url: './pages/shixizhiwei/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/gaoxiaoshixixinxi/admin/dist/index.html#/login";
