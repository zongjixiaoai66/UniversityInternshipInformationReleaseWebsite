<template>
	...
	<div class="navbar" style="background-color: var(--publicSubColor) !important;border-color: var(--publicMainColor);border-bottom-width: 5px;border-bottom-style:  dashed;border-top-width: 5px;border-top-style:  dashed" :style="{background:heads.headBgColor,height:heads.headHeight,boxShadow:heads.headBoxShadow,lineHeight:heads.headHeight}">
