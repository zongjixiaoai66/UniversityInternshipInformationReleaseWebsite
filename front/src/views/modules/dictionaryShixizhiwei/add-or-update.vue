<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="实习职位编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="实习职位编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="实习职位编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="实习职位编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="实习职位" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="实习职位" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="实习职位" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    this.$http({
                        ...
                        method: "post",
                        data: {"dicCode":"shixizhiwei_types"}
                    }).then(({ data }) => {
                        if (data && data.code === 0) {
            ...
            onSubmit() {
                if((!this.ruleForm.indexName)){
                    this.$message.error('实习职位不能为空');
                    return
                }
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        let ruleForm = this.ruleForm;
                        ruleForm["dicCode"]="shixizhiwei_types";
                        ruleForm["dicName"]="实习职位";
                        this.$http({
