...
|| (sessionTable == 'qiye' && scope.row.qiyeId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gaoxiaoshixixinxi/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.qiyeId = el.qiyeId;//---
                            forum.qiyeName = el.qiyeName;
                            forum.qiyeTypes = el.qiyeTypes;
                            forum.qiyePhone = el.qiyePhone;
                            forum.qiyeEmail = el.qiyeEmail;
                            forum.qiyePhoto = el.qiyePhoto;
                            forum.qiyeChenglishijianTime = el.qiyeChenglishijianTime;
                            forum.qiyeContent = el.qiyeContent;
                            forum.qiyeDelete = el.qiyeDelete;
                            forum.createTime = el.createTime;
